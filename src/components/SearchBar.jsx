...
export default function SearchBar() {
  ...
  return (
    <div className='flex flex-row-reverse items-center shadow-lg bg-white rounded-lg pl-4 pr-2 py-1'>
        <input
            value={searchText}
